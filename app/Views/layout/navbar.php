		...
		<ul class="navbar-nav">
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
					<a class="dropdown-item" href="<?= base_url('about') ?>"><i class="fas fa-bullhorn"></i>&nbsp;&nbsp;Tentang FLS2N</a>
					<?php if (logged_in()) : ?>
					...
					<?php else : ?>
						<a class="dropdown-item" href="<?= base_url('registry') ?>"><i class="fas fa-user-edit"></i>&nbsp;&nbsp;Registrasi FLS2N</a>
						<a class="dropdown-item" href="<?= base_url('semnas') ?>"><i class="fas fa-th-list"></i>&nbsp;&nbsp;Peserta FLS2N</a>
