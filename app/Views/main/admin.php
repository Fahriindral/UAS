...
<div class="container">
    <div class="row">
        <div class="col">
            <div class="info">
                <center>
                    <h2><i class="fas fa-th-list"></i>&nbsp;&nbsp;Kelola Data FLS2N SMA/MA 2023</h2>
                </center>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($semnas as $dt) : ?>
                            <tr>
                                ...
                                <td><?= $dt['lomba']; ?></td>
                                <td class="btn-class">
                                    <a type="button" class="btn btn-success btn-sm" href="https://api.whatsapp.com/send?phone=<?= $dt['wa']; ?>&text=Hallo"><i class="fab fa-whatsapp"></i>&nbsp;&nbsp;Hubungi</a>
                        ...
                        <form action="<?= base_url('admin/update/'.$dt['id']); ?>" method="POST">
                            ...
                            <div class="modal-body bg-dark">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="box-registry">
                                        <i class="fas fa-building"></i>
                                        <input type="text" placeholder="Asal Sekolah" name="insek" value="<?= $dt['insek']; ?>" required>
                                    </div>
                                    ...
                                    <div class="box-registry">
                                        <select class="form-control" placeholder="Kategori" name="jenkel" value="<?= $dt['jenkel']; ?>" required>
                                                <option value="">-Pilih Kategori-</option>
                                                <option value="Putra">Putra</option>
                                                <option value="Putri">Putri</option>
                                        </select>
                                    ...
                                    <div class="box-registry">
                                        <select class="form-control" placeholder="Mata Lomba" name="lomba" value="<?= $dt['lomba']; ?>" required>
                                                <option value="">-Pilih Cabang Lomba-</option>
                                                <option value="Solo Gitar">Solo Gitar</option>
                                                <option value="Solo Vocal">Solo Vocal</option>
                                                <option value="Cipta Lagu">Cipta Lagu</option>
